...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i14.IPhoneRepositoryFacade>(
        () => _i15.PhoneAuthRepository(gh<_i7.FirebaseAuth>()));
    gh.lazySingleton<_i16.NTP>(() => coreInjectableModule.ntp);
    gh.factory<_i17.PhoneAuthBloc>(() => _i17.PhoneAuthBloc(
          gh<_i7.FirebaseAuth>(),
          gh<_i14.IPhoneRepositoryFacade>(),
        ));
