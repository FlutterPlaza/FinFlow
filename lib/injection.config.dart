...
import 'package:fpb/forgot_password_flow/application/bloc/forgot_password_bloc.dart'
    as _i22;
import 'package:fpb/forgot_password_flow/domain/i_forgot_password_facade.dart'
    as _i12;
import 'package:fpb/forgot_password_flow/infrastructure/forgot_password_repository.dart'
    as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i12.IForgotPasswordRepositoryFacade>(
        () => _i13.ForgotPasswordRepository(
              gh<_i7.FirebaseAuth>(),
              gh<String>(),
            ));
    ...
    gh.factory<_i22.ForgotPasswordBloc>(() => _i22.ForgotPasswordBloc(
          gh<_i22.ForgotPasswordState>(),
          forgotPasswordRepositoryFacade:
              gh<_i12.IForgotPasswordRepositoryFacade>(),
        ));
