...
class SvgNames {
  ...
  static String sendIllustration = '${path}send_illustration.svg';
  static String transIllustration = '${path}transaction_illustration.svg';
  static String apple = '${path}apple.svg';
